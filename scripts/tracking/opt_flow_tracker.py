...
def OptflowTracker(self, frames, firstImage, smoothingmethod, segMeth, exp_parameter, updateconvax, progessbar, timelapse, tmp_dir):
    ...
    detect_interval = 1
    firstDetections, updatedTrackIdx, updateDetections, old_trackIdx, lostTracks,\
    ...
    for i, frame in enumerate(frames):
        ...
        try:
            ...
            frame_gray = common.call_preprocessing(frame, smoothingmethod)
            ...
            for ii, (new, old) in enumerate(zip(good_new, secondDetections)):
                ...
                if CellInfo:
                    tmp_inf = CellInfo[ii]
                    tmp_inf = tmp_inf[1:]
                    tmpList = list(common.concatenateList([i, int(cellId), tmp_inf]))
